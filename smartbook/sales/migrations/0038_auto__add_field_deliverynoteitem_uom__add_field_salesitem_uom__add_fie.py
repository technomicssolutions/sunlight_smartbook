...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeliveryNoteItem.uom'
        db.add_column(u'sales_deliverynoteitem', 'uom',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesItem.uom'
        db.add_column(u'sales_salesitem', 'uom',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuotationItem.uom'
        db.add_column(u'sales_quotationitem', 'uom',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DeliveryNoteItem.uom'
        db.delete_column(u'sales_deliverynoteitem', 'uom')

        # Deleting field 'SalesItem.uom'
        db.delete_column(u'sales_salesitem', 'uom')

        # Deleting field 'QuotationItem.uom'
        db.delete_column(u'sales_quotationitem', 'uom')
    ...
    models = {
        ...
        u'sales.deliverynoteitem': {
            ...
            'uom': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
        u'sales.quotation': {
